        ...
        <div className=' p-16 px-20 '>
          <div className='grid grid-cols-3 gap-12 py-8'>
            {currentProducts.map(product => (
              <div key={product.id} className='shadow-xl rounded-lg bg-[#FFFFFF]'>
                <Link to={`/product/${product.id}`}>
                  <img src={product.image} className='w-full h-72' alt="" />
                </Link>
                <div className='px-4 py-5'>
                  <Link to={`/product/${product.id}`}>
                    <h4 className='text-[#642C0C] font-bold text-2xl pt-1-1'>{product.name}</h4>
                  </Link>
                  <p className='text-sm text-[#979390] py-1'>{product.headline}</p>
                  <h4 className='text-[#642C0C] font-semibold text-1xl'>{product.price}</h4>
                </div>
              </div>
            ))}
          </div>
